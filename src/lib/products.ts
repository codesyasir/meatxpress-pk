...
export const products: Product[] = [
  // ───────── FISH ─────────
  {
    ...
    badge: "Best Seller", inStock: false, weight: "Per piece ~2.5 kg", origin: "Punjab Rivers",
    reviews: [
  ...
  },
  {
    ...
    badge: "Premium", inStock: false, weight: "Per piece ~1.5 kg", origin: "Chenab River",
    reviews: [
  ...
  },
  {
    ...
    inStock: false, weight: "Per piece ~1.5 kg", origin: "Local Farms",
    reviews: [
  ...
  },
  {
    ...
    badge: "Local Favourite", inStock: false, weight: "Per kg", origin: "Local Rivers",
    reviews: [
  ...
  },
  {
    ...
    badge: "Ready to Cook", inStock: false, weight: "900g pack", origin: "Our Kitchen",
    reviews: [
  ...
  {
  id: 6, name: "Masala Rahu Fish (Ready to Fry/Grill)", slug: "masala-fish",
  ...
  inStock: true,
  weight: "Per kg",
  origin: "Fresh Rahu — Punjab Rivers",
  reviews: [
    { id: 1, name: "Ahmed Raza", rating: 5, comment: "Best masala fish in Lahore! Taste bilkul restaurant jaisi.", date: "2026-09-10" },
    { id: 2, name: "Fatima Khan", rating: 5, comment: "Ghar pe banaya, sab ne tarif ki. Will order again!", date: "2026-09-12" },
    { id: 3, name: "Usman Ali", rating: 5, comment: "Fully marinated, just fried it and wow. Amazing taste.", date: "2026-09-15" },
  ]
},
  {
    ...
    inStock: false, weight: "Per piece ~1.5 kg", origin: "Punjab Rivers",
    reviews: [
  ...
  // ───────── CHICKEN ─────────
  {
    ...
    badge: "Farm Fresh", inStock: false, weight: "1–1.5 kg approx", origin: "Lahore Farms",
    reviews: [
  ...
  // ───────── EGGS ─────────
  {
    ...
    badge: "Farm Fresh", inStock: false, weight: "12 eggs", origin: "Local Farms",
    reviews: [
  ...
  // ───────── BEEF ─────────
  {
    ...
    badge: "Fresh Daily", inStock: false, weight: "Per kg", origin: "Local Farms",
    reviews: [
  ...
  },
  {
    ...
    inStock: false, weight: "Per kg", origin: "Local Farms",
    reviews: [
  ...
  },
  {
    ...
    badge: "Popular", inStock: false, weight: "Per kg", origin: "Local Farms",
    reviews: [
  ...
  },
  {
    ...
    inStock: false, weight: "1 piece", origin: "Local Farms",
    reviews: [
  ...
  },
  {
    ...
    inStock: false, weight: "Per kg (~1.5–2.5 kg)", origin: "Local Farms",
    reviews: [
  ...
  },
  {
    ...
    badge: "BBQ Favourite", inStock: false, weight: "Per kg", origin: "Local Farms",
    reviews: [
  ...
  },
  {
    ...
    inStock: false, weight: "4 pieces / set", origin: "Local Farms",
    reviews: [
